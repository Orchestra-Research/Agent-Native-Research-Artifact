...
The goal of this folder is to simulate what the `ingestor` skill would produce for a concrete paper input. It binds claims, experiments, evidence, code stubs, and the failed plain-depth branch into one traversable artifact.
...
| File | Description |
|------|-------------|
| [exploration_tree.yaml](trace/exploration_tree.yaml) | 9-node research DAG covering the plain-depth failure, residual decision, and depth-scaling path |
